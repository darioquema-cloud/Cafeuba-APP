...
export const TIPOS_COSTO=["Mano de Obra","Energia","Agua","Logistica","Empaques","Mantenimiento Maquinaria","Mantenimiento Infraestructura","Seguridad Social","Horas Extras","Administracion","Herramientas","Equipos","Papeleria","Internet","Servicios Generales","Apoyo Cargue Descargue"];
export const CENTROS=["Central de Beneficio","Trilladora","Tostado","Maquila","Bodega Cafe Fino"];
export const CENTRO_COL={"Central de Beneficio":C.teal,"Trilladora":C.purple,"Tostado":C.orange,"Maquila":C.gold,"Bodega Cafe Fino":C.green};
export const CENTRO_BG={"Central de Beneficio":C.tealBg,"Trilladora":C.purpleBg,"Tostado":C.orangeBg,"Maquila":C.goldBg,"Bodega Cafe Fino":C.greenBg};
