...
export function UbaTostado({blendsTostado,setBlendsTostado,blendsFino,lotesFino,setLotesFino,setBlendsFino,empaques,setEmpaques,tiposEmpaque,setTiposEmpaque,necesidadesTostado,setNecesidadesTostado,inventariosMensuales,setInventariosMensuales,costos}){
  ...
  return(<div>
    ...
    {tab==="tueste"&&<TabTueste blendsTostado={blendsTostado} setBlendsTostado={setBlendsTostado} blendsFino={blendsFino} lotesFino={lotesFino} setLotesFino={setLotesFino} setBlendsFino={setBlendsFino} empaques={empaques} inventariosMensuales={inventariosMensuales} setInventariosMensuales={setInventariosMensuales} costos={costos}/>}
